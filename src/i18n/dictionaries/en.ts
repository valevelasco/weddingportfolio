...
export const en: Dictionary = {
  ...
  aboutPage: {
    ...
    hero: {
      ...
      titleLine1: 'A Colombian heart,',
      titleLine2: 'a Swiss home.',
      body: "I grew up in Popayán, a colonial city in Colombia known for its food and its warmth. I studied audiovisual communication, and storytelling has shaped the way I see the world ever since. I met my husband in Colombia, and years later, we decided to build our life together in his home country. I moved to Switzerland five years ago, and somewhere between the mountains and the quiet, I found the way I wanted to photograph weddings: unposed, patient, close to the people in front of me.",
    ...
    story: {
      ...
      body: "A handful of portraits, yes, but the rest is documentation. I shoot in natural light wherever possible and keep my presence small. In editing, I lean into warm, soft tones: beige, pastel, timeless, so every gallery feels cohesive, elegant and true to how the day felt. Based in Switzerland, I'm available for weddings across the country and open to traveling for destination weddings in Europe.",
    },
